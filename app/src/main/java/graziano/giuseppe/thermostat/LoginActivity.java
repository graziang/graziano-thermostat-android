...
public class LoginActivity extends AppCompatActivity implements Response.Listener, Response.ErrorListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showProgress(true);
        HttpClient.getUserLogin(this, this);
    }
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            MainActivity.user.setUsername(email);
    ...
    public void onErrorResponse(VolleyError error) {
        ...
        if(MainActivity.user.getUsername().length() > 0) {
            mPasswordView.setError(HttpClient.getErrorMessage(error));
